    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <form className="p-4 flex flex-col space-y-2 w-3/4 lg:w-1/2">
                ...
                <button type="submit" className="cursor-pointer bg-blue-500 border border-black py-1 px-2 rounded-full text-white font-bold w-1/2 mx-auto my-2">Log In</button>
            </form>
